$(document).ready(function () {
  ...
  `;
    ...
    `;
      ...
      const isActive = parseInt(is_active, 10) === 1;
  ...
  $("#filterActive").on("click", function () {
    ...
    $("#filterActive").addClass("is-selected");
    $("#filterArchived").removeClass("is-selected");
  ...
  $("#filterArchived").on("click", function () {
    ...
    $("#filterArchived").addClass("is-selected");
    $("#filterActive").removeClass("is-selected");
