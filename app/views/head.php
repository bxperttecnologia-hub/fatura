...
<head>
    ...
    $supportChatEnabled = !in_array($currentPage, ['login.php', 'register.php', 'invoice_public.php'], true);

    if ($supportChatEnabled) {
        echo '<link rel="stylesheet" href="assets/css/support-chat.css">';
    }
    ...
    <?php if ($supportChatEnabled): ?>
        ...
        <script src="assets/js/support-chat.js" defer></script>
    <?php endif; ?>
